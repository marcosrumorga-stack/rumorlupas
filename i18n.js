...
const I18N = {
  pt: {
    ...
    "revThanks.text": "Recebemos sua avaliação. Obrigado por reservar um minuto pra isso — ajuda mais gente do que você imagina.",
  ...
  en: {
    ...
    "revThanks.text": "Your review arrived. Thank you for taking a minute — it helps more people than you would think.",
  ...
  es: {
    ...
    "revThanks.text": "Recibimos tu opinión. Gracias por dedicarle un minuto — ayuda a más gente de la que imaginas.",
