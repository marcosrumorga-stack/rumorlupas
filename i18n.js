...
const I18N = {
  pt: {
    ...
    "league.soonLong": "Camisolas de futebol a caminho da RumorLupas. Envio para toda a União Europeia, personalização com nome e número.",
  ...
  en: {
    ...
    "league.soonLong": "Football shirts on their way to RumorLupas. Shipping across the European Union, with a name and number printed on request.",
  ...
  es: {
    ...
    "league.soonLong": "Camisetas de fútbol en camino a RumorLupas. Envío a toda la Unión Europea, con nombre y número si lo quieres.",
