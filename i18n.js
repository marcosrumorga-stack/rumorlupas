...
const I18N = {
  pt: {
    ...
    "trust.title": "Comprar sem receio",
    "trust.photos.t": "As fotos são das lupas que vai receber",
    "trust.photos.d": "Fotografamos cada par que temos à venda. A marca de água do javali é nossa — não usamos imagens de catálogo nem fotos de outras lojas.",
    "trust.unit.t": "Uma unidade de cada",
    "trust.unit.d": "A maior parte das cores existe em exemplar único, e o site diz-lhe quando resta a última. Não é revenda em massa.",
    "trust.returns.t": "14 dias para devolver",
    "trust.returns.d": "Por lei europeia, sem ter de justificar. Se não servir ou não gostar, devolve e é reembolsado.",
    "trust.payment.t": "O pagamento não passa por nós",
    "trust.payment.d": "É o Stripe que processa. Nunca vemos os dados do seu cartão, e mantém todas as proteções que o seu banco lhe dá.",
    "trust.company.t": "Empresa registada em Portugal",
    "trust.company.d": "RumorLupas LTDA, NIF 264564375. Morada e contacto nos Termos e Condições.",
    "rev.title": "Como foram as suas lupas?",
    "rev.intro": "Duas linhas chegam. O que escrever aqui pode aparecer na página do modelo, para ajudar quem está a decidir — e é lido por uma pessoa antes de ser publicado.",
    "rev.name": "Primeiro nome",
    "rev.nameNote": "Só o primeiro nome. Não publicamos apelidos.",
    "rev.model": "Que modelo comprou?",
    "rev.modelPick": "Escolha o modelo",
    "rev.rating": "Que nota dá?",
    "rev.text": "A sua avaliação",
    "rev.consent": "Autorizo a RumorLupas a publicar o meu primeiro nome e o texto desta avaliação no site.",
    "rev.send": "Enviar avaliação",
    "revThanks.title": "Obrigado!",
    "revThanks.text": "A sua avaliação chegou. Vamos lê-la e, se a publicarmos, aparece na página do modelo com o seu primeiro nome.",
    "meta.review.title": "Deixar uma avaliação — RumorLupas",
    "meta.review.desc": "Conte como foram as suas lupas RumorLupas.",
    ...
    "color.azul-lente-azul": "Azul · lente azul",
    "color.vermelha-lente-laranja": "Vermelha · lente laranja",
    "color.vermelha-lente-preta": "Vermelha · lente preta",
  ...
  en: {
    ...
    "trust.title": "Buying with confidence",
    "trust.photos.t": "The photos are of the pair you will receive",
    "trust.photos.d": "We photograph every pair we have for sale. The boar watermark is ours, and we use no catalogue images or other shops' photos.",
    "trust.unit.t": "One of each",
    "trust.unit.d": "Most colours exist as a single pair, and the site tells you when the last one is left. This is not bulk resale.",
    "trust.returns.t": "14 days to return",
    "trust.returns.d": "European law, no reason needed. If they do not fit or you do not like them, send them back and you are refunded.",
    "trust.payment.t": "The payment does not pass through us",
    "trust.payment.d": "Stripe handles it. We never see your card details, and you keep every protection your bank gives you.",
    "trust.company.t": "A registered company in Portugal",
    "trust.company.d": "RumorLupas LTDA, tax number 264564375. Address and contact in the Terms and Conditions.",
    ...
    "revThanks.text": "Your review arrived. We will read it, and if we publish it, it appears on the model's page with your first name.",
    ...
    "color.azul-lente-azul": "Blue · blue lens",
    "color.vermelha-lente-laranja": "Red · orange lens",
    "color.vermelha-lente-preta": "Red · black lens",
  ...
  es: {
    ...
    "trust.title": "Comprar con tranquilidad",
    "trust.photos.t": "Las fotos son de las gafas que vas a recibir",
    "trust.photos.d": "Fotografiamos cada par que tenemos a la venta. La marca de agua del jabalí es nuestra, y no usamos imágenes de catálogo ni fotos de otras tiendas.",
    "trust.unit.t": "Una unidad de cada",
    "trust.unit.d": "La mayoría de los colores existe en ejemplar único, y el sitio te avisa cuando queda el último. No es reventa en masa.",
    "trust.returns.t": "14 días para devolver",
    "trust.returns.d": "Por ley europea, sin tener que justificarlo. Si no te sirven o no te gustan, las devuelves y te reembolsamos.",
    "trust.payment.t": "El pago no pasa por nosotros",
    "trust.payment.d": "Lo procesa Stripe. Nunca vemos los datos de tu tarjeta, y conservas todas las protecciones que te da tu banco.",
    "trust.company.t": "Empresa registrada en Portugal",
    "trust.company.d": "RumorLupas LTDA, NIF 264564375. Dirección y contacto en los Términos y Condiciones.",
    ...
    "revThanks.text": "Tu opinión ha llegado. La leeremos y, si la publicamos, aparecerá en la página del modelo con tu nombre.",
    ...
    "color.azul-lente-azul": "Azul · lente azul",
    "color.vermelha-lente-laranja": "Rojo · lente naranja",
    "color.vermelha-lente-preta": "Rojo · lente negra",
